 ...
 * that need to listen to events of active {@link Component}s of the
 * {@link Presenter}'s {@link View}.
 * <P>
 * An annotated {@link Method} is expected to be a void {@link Method} and has
 * to receive exactly 1 {@link Parameter} of an {@link ComponentEvent}
 * implementation, or have at least one anonymous event type set.
 * <P>
...
public @interface Listen {
	...
	/**
	 * Defines the componentId whose corresponding {@link Component} the
	 * {@link Method} annotated with @{@link Listen} listens to.
	 * <P>
	 * The componentId has to be the one that is used upon registering the
	 * {@link Component} as an active component to its {@link View} during the
	 * view's UI setup.
	 * <P>

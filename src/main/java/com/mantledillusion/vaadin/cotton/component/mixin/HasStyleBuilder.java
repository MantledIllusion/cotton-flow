...
/**
 * {@link ComponentBuilder} for {@link HasStyle} implementing
 * {@link Component}s.
 *
 * @param <C>
 ...
 */
public interface HasStyleBuilder<C extends HasStyle, B extends HasStyleBuilder<C, B>> extends ComponentBuilder<C, B> {
